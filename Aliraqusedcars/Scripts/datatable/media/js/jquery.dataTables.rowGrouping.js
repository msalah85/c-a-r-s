    ...
    $.fn.rowGrouping = function (options) {
        ...
        return this.each(function (index, elem) {
            ...
            function fnCreateGroupRow(sGroupCleaned, sGroup, iColspan) {
                ...
                // cut only 50 char
                //if (sGroupCleaned.length > 0)
                //    sGroupCleaned = sGroupCleaned.substr(50);
                ...
                if (properties.bSetGroupingClassOnTR) {
                    nGroup.className = properties.sGroupingClass + " alert alert-warning ";// + sGroupCleaned;
                } else {
                    nCell.className = properties.sGroupingClass + " alert alert-warning ";// + sGroupCleaned;
                }
                ...
                $(nCell).attr("style", "background-color: #fcf8e3!important;");
            ...
            function _fnCreateGroup2Row(sGroup2, sGroupLabel, iColspan, oParentGroup) {
                ...
                if (properties.bSetGroupingClassOnTR) {
                    nGroup2.className = properties.sGroupingClass2 + " alert alert-warning "; // + sGroup2;
                } else {
                    nCell2.className = properties.sGroupingClass2 + " alert alert-warning "; // + sGroup2;
                }
                ...
                $(nCell2).attr("style", "border-top:0!important;");
                $(nGroup2).attr("style", "background-color: #fcf8e3!important;");
            ...
            function _fnGetCleanedGroup(sGroup) {
                if (sGroup === undefined || sGroup === null || sGroup === "") return "-";
