...
(function ($) {
    $.fn.columnFilter = function (options) {
        ...
        //var sTableId = "table";
        var sRangeFormat = "من {from} إلى {to}";
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" dir="ltr" class="date_range_filter form-control" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker({ autoclose: true });
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text" dir="ltr" class="date_range_filter form-control" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            if (bMultiselect) {
                ...
                select.change(function () {
                    ...
                    commonManger.showOptionPrintTitle($('#divPaid select option:selected').text());
                    //var val = $(this).val();
                    if ($(this).val() != "") {
                        $(this).removeClass("search_init");
                    } else {
        ...
        var defaults = {
            ...
            iFilteringDelay: 500,
            aoColumns: null,
            sRangeFormat: sRangeFormat, //"From {from} to {to}",
            sDateFromToken: "from",
            sDateToToken: "to"
        };
