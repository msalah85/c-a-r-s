    ...
    var factory = function ($, DataTable) {
        ...
        var ZeroClipboard_TableTools = {
            ...
            $: function (thingy) {
                ...
                if (!thingy.addClass && $(thingy).is('.visible-print')) {
        ...
        (function ($, window, document) {
            ...
            TableTools.prototype = {
                ...
                "_fnCreateButton": function (oConfig, bCollectionButton) {
                    ...
                    if (this.s.dt.iTabIndex !== -1) {
                        $(nButton).attr('tabindex', this.s.dt.iTabIndex).attr('aria-controls', this.s.dt.sTableId)
                ...
                "_fnCollectionShow": function (nButton, oConfig) {
                    $('#main-content').removeClass('no-margin');
                    var
                        that = this,
                        oPos = $(nButton).offset(),
                ...
                "_fnPrintStart": function (oConfig) {
                    ...
                    // show print header
                    $("<div>").load("/Templates/print-header.html#car-print-header", function () {
                        var $thml = $(this).html();
                        ...
                        today = yyyy + '/' + mm + '/' + dd;
                        $(document.body).prepend($thml);
                        $('span.current-date').text(today);
                    });
                ...
                "_fnPrintEnd": function (e) {
                    $('#main-content').removeClass('no-margin');
                    $('div.car-print-header').remove(); // remove print header
                    var that = this;
                    var oSetDT = this.s.dt;
            ...
            TableTools.BUTTONS = {
                ...
                "copy": $.extend({}, TableTools.buttonBase, {
                    ...
                    "fnComplete": function (nButton, oConfig, flash, text) {
                        ...
                        this.fnInfo('<h6>تم نسخ البيانات</h6>' +
                            '<p>تم نسخ ' + lines + ' حقل' + plural + ' إلى الذاكرة.</p>',
                            1500
                        );
                    }
                }),
                ...
                "print": $.extend({}, TableTools.buttonBase, {
                    ...
                    "sMessage": function () { return '<div class="print-h-margin-right">' + $('.page-header').html() + '</div>'; },
                    "bShowAll": false,
                ...
                //    "sAjaxUrl": "/InvoicesPayView.aspx/LoadData?funName=InvoicePay_SelectList", //"/xhr.php",
                //    "sButtonText": "Ajax",
                //    "fnClick": function (nButton, oConfig) {
