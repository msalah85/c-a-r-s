    ...
    pageManager = function () {
        ...
        var
            ...
            pageProperties = function () {
                // show emp name
                if (pageElem.empID.val() * 1 > 0) {
                    var dto = { actionName: 'Rents_Properties', value: pageElem.empID.val() };
                    dataService.callAjax('POST', JSON.stringify(dto), sUrl + 'GetData', showProp, commonManger.errorException);
                }
            },
            showProp = function (data) {
                ...
                if (jsn)
                    $('.emp-name').text(jsn.UserFullName);
            },
            initPageElemnts = function () {
                ...
                if (qs.eid) {
                    var iD = decodeURIComponent(qs.eid);
                    pageElem.empID.val(iD);
                    $('a.list').attr('href', 'EmployeeRents.aspx?id=' + iD)
                }
            },
            ...
            pageEvents = function () {
                ...
                pageElem.SaveAll.click(function (e) {
                    ...
                    if (checkMe) {
                        ...
                        var fieldsDetails = commonManger.returnFiledsNamesToSave("divMyForm"), valuesDetails = [];
            ...
            succesSaveAll = function (data) {
                ...
                if (data.Status) {
                    ...
                    window.location.href = 'EmployeeRents.aspx?id=' + pageElem.empID.val();
                }
                else {
