...
/*!jquery.cookie.js jquery.cookie v1.4.1*/
...
/*! app/master.js */
(function(){"use strict";var i=window.location.pathname.toLowerCase(),t=i.substr(i.lastIndexOf("/")+1),r=function(){var n=JSON.stringify({value:t});dataService.callAjax("Post",n,"home.aspx/GetData",u,commonManger.errorException)},u=function(n){var i=$.parseXML(n.d),r=$.xml2json(i).list,u=$.xml2json(i).list1,f=$.xml2json(i).list2,o=jQuery.grep(["home","error","expensesoncarreportprint","paycarspaymentsprint","paycarspaymentsreport","shippaymentsreport","shippaymentsreportprint","soldcarsreport","soldcarsreportprint","carswaitedshipreport","carswaitedshipreportprint","custompaymentsreport","custompaymentsreportprint","expensesoncarreport","signature","cardetailsprint","invoiceshippingprint","reexportcarsprint","clientspaymentsprint","bookingbol","images","partsprint","shipinvoicepaymentsdetails","payinvoicepaymentdetails","invoicescustomsprint","carshippexpensesprint","searchcars","shipinvoicepaymentsprint","customspaymentsdetails","carshopexpensesprint","carshopexpenses","carshippexpenses","invoicesaleadd","searchpayments","searchsales","searchshipping","invoicesaleprint","clientcars","vacations","salaryprint","advancerepays","advances","clientbuyers","payinvoicepaymentsprint","customspaymentsmasterprint","auctioncommissionprint","cars-to-active-website","carnotesen","receiptvoucherprint","clientdiscounts","receiptpaymentsadd","receiptpaymentsview","receiptpaymentsprint","clientpaymentsreviewprint","clientextras","receiptvoucherviewdeleted","receiptpaymentsviewdeleted","clientpaymentsviewdeleted","payinvoicepaymentspendingprint","contract","printcardiscount","printcarextra","iraq-cars","share-car"],function(n){return t.indexOf(n)>-1?t:null}),e;(!f||f.Permit<=0)&&o.length==0&&(window.location.href="error.aspx");void 0!==r&&($(".divDangerCounts").text(r.DangerCounts),$(".divWarningCounts").text(r.WarningCounts));u&&parseInt(u.RequestsViewWebsite,10)>0&&(e='<li><a href="cars-to-active-website.aspx"><div class="clearfix"><span class="pull-right">طلبات عرض سيارات بالموقع<\/span><span class="pull-left badge badge-pink" id="viewNeededCarsCount">'+u.RequestsViewWebsite+"<\/span><\/div><\/a><\/li>",$("ul.navbar-pink").append(e))},f=function(n,t,i){$.gritter.add({title:n,text:t,sticky:i,class_name:"gritter-info"})},e=function(){f("تنبـــــيه الطلبــــات الجــديــدة:","",!0)},n=function(n){window.location.href=n};r();$(document).on("click","a.rptReport",function(n){n.preventDefault();$.cookie("ReportInfo",null,{expires:-2,path:"rpt"});$.cookie("ReportInfo",["","","","0",""],{expires:1,path:"rpt"});window.location.href=$(this).data("url")});$(document).bind("keydown","f6",function(){return n("InvoicePayAdd.aspx"),!1});$(document).bind("keydown","f7",function(){return n("InvoiceShippingAdd.aspx"),!1});$(document).bind("keydown","f8",function(){return n("InvoiceCustomsAdd.aspx"),!1});$(document).bind("keydown","f9",function(){return n("america/carnotes.aspx"),!1});$(document).bind("keydown","f1",function(){return n("clients.aspx"),!1});$(document).bind("keydown","f2",function(){return n("available/1/carslist.aspx"),!1});$(document).bind("keydown","f3",function(){return n("ClientsPaymentsAdd.aspx"),!1});$(document).bind("keydown","f4",function(){return n("PartsAdd.aspx"),!1});$(document).bind("keydown","f12",function(){return!1});$(document).bind("keydown","ctrl+u",function(){return!1})})();
...
(function(n,t,i){n=function(n){var r=function(t,i){return this.CLASS&&"ColVis"==this.CLASS||alert("Warning: ColVis must be initialised with the keyword 'new'"),"undefined"==typeof i&&(i={}),n.fn.dataTable.camelToHungarian&&n.fn.dataTable.camelToHungarian(r.defaults,i),this.s={dt:null,oInit:i,hidden:!0,abOriginal:[]},this.dom={wrapper:null,button:null,collection:null,background:null,catcher:null,buttons:[],groupButtons:[],restore:null},r.aInstances.push(this),this.s.dt=n.fn.dataTable.Api?new n.fn.dataTable.Api(t).settings()[0]:t,this._fnConstruct(i),this};return r.prototype={button:function(){return this.dom.wrapper},fnRebuild:function(){this.rebuild()},rebuild:function(){for(var n=this.dom.buttons.length-1;0<=n;n--)this.dom.collection.removeChild(this.dom.buttons[n]);this.dom.buttons.splice(0,this.dom.buttons.length);this.dom.restore&&this.dom.restore.parentNode(this.dom.restore);this._fnAddGroups();this._fnAddButtons();this._fnDrawCallback()},_fnConstruct:function(i){this._fnApplyCustomisation(i);var r=this,u,f;for(this.dom.wrapper=t.createElement("div"),this.dom.wrapper.className="ColVis",this.dom.button=n("<button />",{"class":this.s.dt.bJUI?"ColVis_Button ColVis_MasterButton ui-button ui-state-default":"ColVis_Button ColVis_MasterButton"}).append("<span>"+this.s.buttonText+"<\/span>").bind("mouseover"==this.s.activate?"mouseover":"click",function(n){n.preventDefault();r._fnCollectionShow()}).appendTo(this.dom.wrapper)[0],this.dom.catcher=this._fnDomCatcher(),this.dom.collection=this._fnDomCollection(),this.dom.background=this._fnDomBackground(),this._fnAddGroups(),this._fnAddButtons(),u=0,f=this.s.dt.aoColumns.length;u<f;u++)this.s.abOriginal.push(this.s.dt.aoColumns[u].bVisible);this.s.dt.aoDrawCallback.push({fn:function(){r._fnDrawCallback.call(r)},sName:"ColVis"});n(this.s.dt.oInstance).bind("column-reorder",function(n,t,i){for(u=0,f=r.s.aiExclude.length;u<f;u++)r.s.aiExclude[u]=i.aiInvertMapping[r.s.aiExclude[u]];n=r.s.abOriginal.splice(i.iFrom,1)[0];r.s.abOriginal.splice(i.iTo,0,n);r.fnRebuild()});this._fnDrawCallback()},_fnApplyCustomisation:function(t){var t,u,i,f;if(n.extend(!0,this.s,r.defaults,t),!this.s.showAll&&this.s.bShowAll&&(this.s.showAll=this.s.sShowAll),!this.s.restore&&this.s.bRestore&&(this.s.restore=this.s.sRestore),t=this.s.groups,u=this.s.aoGroups,t)for(i=0,f=t.length;i<f;i++)(t[i].title&&(u[i].sTitle=t[i].title),t[i].columns)&&(u[i].aiColumns=t[i].columns)},_fnDrawCallback:function(){for(var e=this.s.dt.aoColumns,r=this.dom.buttons,o=this.s.aoGroups,f,t=0,u=r.length;t<u;t++)f=r[t],f.__columnIdx!==i&&n("input",f).prop("checked",e[f.__columnIdx].bVisible);for(r=0,f=o.length;r<f;r++){n:{for(var t=o[r].aiColumns,u=0,s=t.length;u<s;u++)if(!1===e[t[u]].bVisible){t=!1;break n}t=!0}if(t)n("input",this.dom.groupButtons[r]).prop("checked",!0),n("input",this.dom.groupButtons[r]).prop("indeterminate",!1);else{n:{for(t=o[r].aiColumns,u=0,s=t.length;u<s;u++)if(!0===e[t[u]].bVisible){t=!1;break n}t=!0}t?(n("input",this.dom.groupButtons[r]).prop("checked",!1),n("input",this.dom.groupButtons[r]).prop("indeterminate",!1)):n("input",this.dom.groupButtons[r]).prop("indeterminate",!0)}}},_fnAddGroups:function(){var n,t,i;if("undefined"!=typeof this.s.aoGroups)for(t=0,i=this.s.aoGroups.length;t<i;t++)n=this._fnDomGroupButton(t),this.dom.groupButtons.push(n),this.dom.buttons.push(n),this.dom.collection.appendChild(n)},_fnAddButtons:function(){var t,r=this.s.dt.aoColumns,i,u;if(-1===n.inArray("all",this.s.aiExclude))for(i=0,u=r.length;i<u;i++)-1===n.inArray(i,this.s.aiExclude)&&(t=this._fnDomColumnButton(i),t.__columnIdx=i,this.dom.buttons.push(t));"alpha"===this.s.order&&this.dom.buttons.sort(function(n,t){var i=r[n.__columnIdx].sTitle,u=r[t.__columnIdx].sTitle;return i===u?0:i<u?-1:1});this.s.restore&&(t=this._fnDomRestoreButton(),t.className+=" ColVis_Restore",this.dom.buttons.push(t));this.s.showAll&&(t=this._fnDomShowXButton(this.s.showAll,!0),t.className+=" ColVis_ShowAll",this.dom.buttons.push(t));this.s.showNone&&(t=this._fnDomShowXButton(this.s.showNone,!1),t.className+=" ColVis_ShowNone",this.dom.buttons.push(t));n(this.dom.collection).append(this.dom.buttons)},_fnDomRestoreButton:function(){var t=this;return n('<li class="ColVis_Special '+(this.s.dt.bJUI?"ui-button ui-state-default":"")+'">'+this.s.restore+"<\/li>").click(function(){for(var n=0,i=t.s.abOriginal.length;n<i;n++)t.s.dt.oInstance.fnSetColumnVis(n,t.s.abOriginal[n],!1);t._fnAdjustOpenRows();t.s.dt.oInstance.fnAdjustColumnSizing(!1);t.s.dt.oInstance.fnDraw(!1)})[0]},_fnDomShowXButton:function(t,i){var r=this;return n('<li class="ColVis_Special '+(this.s.dt.bJUI?"ui-button ui-state-default":"")+'">'+t+"<\/li>").click(function(){for(var n=0,t=r.s.abOriginal.length;n<t;n++)-1===r.s.aiExclude.indexOf(n)&&r.s.dt.oInstance.fnSetColumnVis(n,i,!1);r._fnAdjustOpenRows();r.s.dt.oInstance.fnAdjustColumnSizing(!1);r.s.dt.oInstance.fnDraw(!1)})[0]},_fnDomGroupButton:function(t){var r=this,i=this.s.aoGroups[t];return n('<li class="ColVis_Special '+(this.s.dt.bJUI?"ui-button ui-state-default":"")+'"><label><input type="checkbox" /><span>'+i.sTitle+"<\/span><\/label><\/li>").click(function(t){var u=!n("input",this).is(":checked");for("li"!==t.target.nodeName.toLowerCase()&&(u=!u),t=0;t<i.aiColumns.length;t++)r.s.dt.oInstance.fnSetColumnVis(i.aiColumns[t],u)})[0]},_fnDomColumnButton:function(t){var i=this,r=this.s.dt.aoColumns[t],u=this.s.dt,r=null===this.s.fnLabel?r.sTitle:this.s.fnLabel(t,r.sTitle,r.nTh);return n("<li "+(u.bJUI?'class="ui-button ui-state-default"':"")+'><label><input type="checkbox" /><span>'+r+"<\/span><\/label><\/li>").click(function(r){var f=!n("input",this).is(":checked"),e;"li"!==r.target.nodeName.toLowerCase()&&(f=!f);e=n.fn.dataTableExt.iApiIndex;n.fn.dataTableExt.iApiIndex=i._fnDataTablesApiIndex.call(i);u.oFeatures.bServerSide?(i.s.dt.oInstance.fnSetColumnVis(t,f,!1),i.s.dt.oInstance.fnAdjustColumnSizing(!1),(""!==u.oScroll.sX||""!==u.oScroll.sY)&&i.s.dt.oInstance.oApi._fnScrollDraw(i.s.dt),i._fnDrawCallback()):i.s.dt.oInstance.fnSetColumnVis(t,f);n.fn.dataTableExt.iApiIndex=e;"input"===r.target.nodeName.toLowerCase()&&null!==i.s.fnStateChange&&i.s.fnStateChange.call(i,t,f)})[0]},_fnDataTablesApiIndex:function(){for(var n=0,t=this.s.dt.oInstance.length;n<t;n++)if(this.s.dt.oInstance[n]==this.s.dt.nTable)return n;return 0},_fnDomCollection:function(){return n("<ul />",{"class":this.s.dt.bJUI?"ColVis_collection ui-buttonset ui-buttonset-multi":"ColVis_collection"}).css({display:"none",opacity:0,position:this.s.bCssPosition?"":"absolute"})[0]},_fnDomCatcher:function(){var r=this,i=t.createElement("div");return i.className="ColVis_catcher",n(i).click(function(){r._fnCollectionHide.call(r,null,null)}),i},_fnDomBackground:function(){var t=this,i=n("<div><\/div>").addClass("ColVis_collectionBackground").css("opacity",0).click(function(){t._fnCollectionHide.call(t,null,null)});return"mouseover"==this.s.activate&&i.mouseover(function(){t.s.overcollection=!1;t._fnCollectionHide.call(t,null,null)}),i[0]},_fnCollectionShow:function(){var o=this,f=n(this.dom.button).offset();var i=this.dom.collection,r=this.dom.background,u=parseInt(f.left,10),e=parseInt(f.top+n(this.dom.button).outerHeight(),10);this.s.bCssPosition||(i.style.top=e+"px",i.style.left=u+"px");n(i).css({display:"block",opacity:0});r.style.bottom="0px";r.style.right="0px";e=this.dom.catcher.style;e.height=n(this.dom.button).outerHeight()+"px";e.width=n(this.dom.button).outerWidth()+"px";e.top=f.top+"px";e.left=u+"px";t.body.appendChild(r);t.body.appendChild(i);t.body.appendChild(this.dom.catcher);n(i).animate({opacity:1},o.s.iOverlayFade);n(r).animate({opacity:.1},o.s.iOverlayFade,"linear",function(){n.browser&&n.browser.msie&&n.browser.version=="6.0"&&o._fnDrawCallback()});this.s.bCssPosition||(f="left"==this.s.sAlign?u:u-n(i).outerWidth()+n(this.dom.button).outerWidth(),i.style.left=f+"px",r=n(i).outerWidth(),n(i).outerHeight(),u=n(t).width(),f+r>u&&(i.style.left=u-r+"px"));this.s.hidden=!1},_fnCollectionHide:function(){var i=this;this.s.hidden||null===this.dom.collection||(this.s.hidden=!0,n(this.dom.collection).animate({opacity:0},i.s.iOverlayFade,function(){this.style.display="none"}),n(this.dom.background).animate({opacity:0},i.s.iOverlayFade,function(){t.body.removeChild(i.dom.background);t.body.removeChild(i.dom.catcher)}))},_fnAdjustOpenRows:function(){for(var t=this.s.dt.aoOpenRows,i=this.s.dt.oApi._fnVisbleColumns(this.s.dt),n=0,r=t.length;n<r;n++)t[n].nTr.getElementsByTagName("td")[0].colSpan=i}},r.fnRebuild=function(n){var i=null,t,u;for("undefined"!=typeof n&&(i=n.fnSettings().nTable),t=0,u=r.aInstances.length;t<u;t++)("undefined"==typeof n||i==r.aInstances[t].s.dt.nTable)&&r.aInstances[t].fnRebuild()},r.defaults={active:"click",buttonText:"Show / hide columns",aiExclude:[],bRestore:!1,sRestore:"Restore original",bShowAll:!1,sShowAll:"Show All",sAlign:"left",fnStateChange:null,iOverlayFade:500,fnLabel:null,bCssPosition:!1,aoGroups:[],order:"column"},r.aInstances=[],r.prototype.CLASS="ColVis",r.VERSION="1.1.1",r.prototype.VERSION=r.VERSION,"function"==typeof n.fn.dataTable&&"function"==typeof n.fn.dataTableExt.fnVersionCheck&&n.fn.dataTableExt.fnVersionCheck("1.7.0")?n.fn.dataTableExt.aoFeatures.push({fnInit:function(n){var t=n.oInit;return new r(n,t.colVis||t.oColVis||{}).button()},cFeature:"C",sFeature:"ColVis"}):alert("Warning: ColVis requires DataTables 1.7 or greater - www.datatables.net/download"),n.fn.dataTable.ColVis=r,n.fn.DataTable.ColVis=r};"function"==typeof define&&define.amd?define(["jquery","datatables"],n):"object"==typeof exports?n(require("jquery"),require("datatables")):jQuery&&!jQuery.fn.dataTable.ColVis&&n(jQuery,jQuery.fn.dataTable)})(window,document);
