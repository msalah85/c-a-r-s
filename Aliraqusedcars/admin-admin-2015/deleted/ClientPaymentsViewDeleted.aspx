<%@ Page Title="عرض إيداعات العملاء الملغاه" Language="C#" EnableSessionState="ReadOnly" MasterPageFile="~/admin-admin-2015/master.master" AutoEventWireup="true" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="/Scripts/deleted/ClientPaymentsView.min.js?v=1.3"></script>
    <style type="text/css">
        .control-group {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="breadcrumbs" class="hidden-print">
        <ul class="breadcrumb">
            ...
            <li><a href="ClientsPaymentsAdd.aspx">اضافة إيداع عميل</a> <span class="divider"><i class="icon-angle-left"></i></span></li>
            <li class="active">إيداعات العملاء الملغاه</li>
        </ul>
    </div>
    <div id="page-content" class="clearfix">
        <div class="page-header position-relative">
            <h1 class="red">تقرير إيداعات العملاء الملغاه</h1>
        </div>
        <div class="row-fluid">
        ...
        <div class="row-fluid">
            <div class="table-header red2-bg">
                عرض إيداعات العملاء الملغاه - المحذوفة<a data-toggle="tooltip" href="ClientsPaymentsAdd.aspx" title="اضافة جديد" data-dismiss="modal"
