<%@ Page Title="أرصدة البنك" Language="C#" EnableSessionState="ReadOnly" MasterPageFile="~/admin-admin-2015/master.master" AutoEventWireup="true" CodeFile="BankBalancesView.aspx.cs" Inherits="BankBalancesView" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="/Scripts/App/BankBalances.min.js?v=2.2"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="breadcrumbs" class="hidden-print">
        <ul class="breadcrumb">
            ...
            <li class="active">أرصــــدة البنك</li>
        </ul>
    </div>
