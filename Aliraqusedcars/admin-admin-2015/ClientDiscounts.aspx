<%@ Page Title="الخصومات" Language="C#" EnableSessionState="ReadOnly" MasterPageFile="~/admin-admin-2015/master.master" AutoEventWireup="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <link href="/Scripts/select2/select2.min.css?v=1.2" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="page-content" class="clearfix">
        <div class="page-header position-relative">
            <h1>الخصومات للعميل: <a class="client-name green"></a></h1>
        </div>
        <!-- add new-->
        <div class="row-fluid" id="addModal">
            <form id="aspnetForm" class="form-horizontal">
                <div class="span4">
                    <div class="">
                        <div class="controls">
                            <input type="hidden" id="ClientDiscountID" name="ClientDiscountID" value="0" />
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="CarID" name="id" class="form-control select2 rtl" data-srch-names="ClientID" data-fn-name="ClientCars_GetBySearch" type="text" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="DiscountAmount">المبلغ: <span class="red">*</span></label>
                        <div class="controls">
                            <input type="text" class="form-control" data-rule-required="true" required id="DiscountAmount" name="DiscountAmount" />$
                        </div>
                    </div>
                </div>
                <div class="span4">
                    <div class="control-group">
                        <label class="control-label" for="Notes">سبب الخصم: <span class="red">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-small btn-success savedate" data-text="اضف خصم">
                                <i class="icon-save"></i>
                                اضف خصم على سيارة للعميل
                            </button>
                        </div>
                    </div>
                </div>
