<%@ Page Title="اضافة إيجار الشركة السنوى" Language="C#" MasterPageFile="~/admin-admin-2015/master.master" AutoEventWireup="true" CodeFile="CompanyRentsAdd.aspx.cs" Inherits="admin_admin_2015_CompanyRentsAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script src="/Scripts/App/RentDetails.min.js?v=1.4"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="breadcrumbs" class="hidden-print">
        <ul class="breadcrumb">
            ...
            <li><a href="CompanyRents.aspx">عرض إيجارات الشركة</a> <span class="divider"><i class="icon-angle-left"></i></span></li>
            <li class="active title">إيجار الشركة السنوى</li>
        </ul>
    </div>
    <div id="page-content" class="clearfix">
        <div class="page-header position-relative">
            <h1 class="title">إيجار الشركة السنوى</h1>
        </div>
        <div class="row-fluid">
            ...
            <div class="span12 widget-container-span">
                <div class="widget-box">
                    <div class="widget-header header-color-green">
                        ...
                        <a class="btn btn-mini btn-warning pull-left addition" title="اضف شيك إيجار" role="button" data-toggle="modal" href="CompanyRentsAdd.aspx#addModal">+ اضف شيك</a>
                    </div>
            ...
            <form role="form">
                <div id="addModal" class="modal hide fade" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row-fluid">
                            <div class="form-horizontal" id="divMyForm" role="form">
                                <div class="span12">
