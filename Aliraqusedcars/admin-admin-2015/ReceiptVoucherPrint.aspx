...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="/Scripts/app/receiptvoucherprint.min.js?v=2.5"></script>
    <style type="text/css">
        #sig {
            width: 500px;
            height: 187px;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="breadcrumbs" class="hidden-print">
        <ul class="breadcrumb hidden-print">
            ...
            <li><a class="receiptvoucher" href="ReceiptVoucherView.aspx">عرض سندات  القبض</a> <span class="divider"><i class="icon-angle-left"></i></span></li>
            <li class="active">طباعة سند القبض</li>
        </ul>
    </div>
    <div id="page-content" class="clearfix">
        <div class="span10 offset2 invoice-body" id="masterForm">
            ...
            <div class="row-fluid padding-right-10">
                ...
                <div class="span4">
                    <center>
                        ...
                        <h2 class="down-title">سـنــــد قـبــــض <small id="RecieptTypeName">عام</small></h2>
                    </center>
                </div>
            ...
            <table width="100%" class="center">
                <tr>
                    <td width="40%">التوقيع <a title="أضف توقيع" data-toggle="modal" data-rel="tooltip" href="#sigModal" class="hidden-print add-sig"><i class="icon-plus-sign bigger-120"></i></a></td>
                    <td>المحاسب</td>
                </tr>
                <tr>
                    <td id="sigView"></td>
