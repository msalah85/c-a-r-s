<%@ Page Title="المرتجعات" Language="C#" MasterPageFile="~/client/Client.master" AutoEventWireup="true" CodeFile="ClientMoneyBack.aspx.cs" Inherits="client_ClientMoneyBack" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentMain" runat="Server">
    <div class="sub-menu">
        <ol class="breadcrumb">
            ...
            <li><a href="ClientDiscounts">الخصومات</a></li>
            <li><a href="ClientExtras">الزيادات</a></li>
        </ol>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-header">المرتجعات <small>المبالغ المسترده إليك من رصيدك</small></h1>
    ...
    <script src="/Scripts/client/ClientMoneyBackManager.min.js"></script>
</asp:Content>
