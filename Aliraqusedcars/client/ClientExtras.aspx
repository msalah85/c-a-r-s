<%@ Page Title="الزيادات على السيارات" Language="C#" MasterPageFile="~/client/Client.master" AutoEventWireup="true" CodeFile="ClientExtras.aspx.cs" Inherits="client_ClientExtras" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentMain" runat="Server">
    ...
    <div class="row">
        <div class="col-sm-12">
            <h1 class="page-header">الزيادات على السيارات</h1>
    ...
    <script src="/Scripts/client/ClientExtrasManager.min.js"></script>
</asp:Content>
